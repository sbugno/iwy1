...
public class DCQArrayOfFlowsObj extends Vector<DCQflowsObj> implements KvmSerializable,HasAttributes
{
    private transient java.lang.Object __source;

    public DCQArrayOfFlowsObj()
    {
    }

    public DCQArrayOfFlowsObj(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public DCQArrayOfFlowsObj(java.util.Collection< DCQflowsObj> initialCapactiy)
    {
        super(initialCapactiy);
    }
    ...
    public void loadFromSoap(java.lang.Object inObj,DCQExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof Vector)
        {
            ...
            for (int i0=0;i0< list.size();i0++)
            {
                ...
                if (j!=null )
                {
                    DCQflowsObj j1= (DCQflowsObj)__envelope.get(j,DCQflowsObj.class,false);
                    add(j1);
                }
            }
        }
    ...
    public void getAttributeInfo(int index, AttributeInfo info) {
        if(index==0)
        {
            ...
            info.setValue("xx2:ArrayOfFlowsObj");
        }
        if(index==1)
        {
            info.name = "arrayType";
            info.namespace= "http://schemas.xmlsoap.org/soap/encoding/";
            info.setValue("xx1:flowsObj[]");
        }
        if(index==2)
        {
            info.name = "xmlns:xx1";
