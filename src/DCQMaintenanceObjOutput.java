...
public class DCQMaintenanceObjOutput extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("Output"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.Output = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.Output = (String)obj;
                }
                else{
                    this.Output = "";
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.Output!=null?this.Output:SoapPrimitive.NullSkip;
        }
        return null;
    }
