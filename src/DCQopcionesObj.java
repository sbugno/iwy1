...
public class DCQopcionesObj extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("opcion"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.opcion = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.opcion = (String)obj;
                }
                else{
                    this.opcion = "";
                }
        ...
        if (info.name.equals("valor"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.valor = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.valor = (String)obj;
                }
                else{
                    this.valor = "";
                }
